...
import { SearchResultDTO } from 'src/app/dtos/SearchResultDTO';
...
export class ObjetHttpService implements ObjetService {
  ...
  async searchItemAsync(searchText: string) {
    ...
    var requete = this.httpClient.get<SearchResult[]>(environment.serviceUrl+"/Objet?searchText="+searchText);
